...
/*   Updated: 2019/11/05 14:03:16 by froussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
	...
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 20 -------------\n"S);
    i =printf("salut=%10.3d\n", -5);
    j =ft_printf("salut=%10.3d\n", -5);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 21 -------------\n"S);
    i =printf("salut=%10.4d\n", -5);
    j =ft_printf("salut=%10.4d\n", -5);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 22 -------------\n"S);
    i =printf("salut=%10.2d\n", -5);
    j =ft_printf("salut=%10.2d\n", -5);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 23 -------------\n"S);
        i =printf("salut=%10.1d\n", -5);
    j =ft_printf("salut=%10.1d\n", -5);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 24 -------------\n"S);
    i =printf("salut=%3.3d\n", -56789);
    j =ft_printf("salut=%3.3d\n", -56789);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 25 -------------\n"S);
    i =printf("salut=%3.3d\n", -5);
	...
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
    printf(B"--------------- TEST 26 -------------\n"S);
    i =printf("salut=%3.10d\n", -5);
    j =ft_printf("salut=%3.10d\n", -5);
	(i != j) ? printf(R"KO Diff return\n") : printf(G"OK\n") ;
	printf("RETURN = printf :%d ft_printf: %d\n"S, i, j);
